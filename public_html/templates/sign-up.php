	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="signup">One of Us.</h4>
			</div>
			<div class="modal-body">
				<form action="" class="form-horizontal">
					...
					<div class="form-group">
						<label for="profilePassword" class="col-sm-4 control-label">Password</label>
						<div class="col-sm-8">
							<input type="password" class="form-control" id="profilePassword" name="profilePassword" placeholder="Password">
						</div>
					</div>
					<div class="form-group">
						<label for="profileConfirmPassword" class="col-sm-4 control-label">Confirm Password</label>
						<div class="col-sm-8">
							<input type="password" class="form-control" id="profileConfirmPassword" name="profileConfirmPassword" placeholder="Confirm Password">
						</div>
					</div>
					<div class="form-group">
